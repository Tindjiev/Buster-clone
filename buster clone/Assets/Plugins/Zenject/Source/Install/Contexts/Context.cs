...
//#endif
        ...
        void InstallZenjectBinding(ZenjectBinding binding)
        {
            ...
            {
                identifierString = binding.Identifier;
            }

            ZenjectId identifierEnum = binding.IdentifierEnum;

            if (identifierString != null)
            {
                identifier = identifierString;
                if (identifierEnum != default)
                {
                    Debug.LogError("Both identifierString's value and identifierEnum's value has been set on GameObject " + binding.gameObject, binding);
                }
            }
            else if (identifierEnum != default)
            {
